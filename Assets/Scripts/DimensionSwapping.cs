...
public class DimensionSwapping : MonoBehaviour
{
    ...
    bool UpdateSaturationCircles()
    {
        ...
        float colorCircleTargetSize = 1.5f;
        ...
        } else
        {
            ...
            if (currentDimension == DimensionFilter.Dimension.Two)
            {
                ...
                //colorCircleTargetSize = -0.63f;
                colorCircleTargetSize = 0f;
            }
        }
        ...
        screenDimensionPreviewMaterial.SetFloat("SaturatedCircleSize", saturatedCircleTargetSize);
        screenDimensionPreviewMaterial.SetFloat("InnerColorCircleSize", colorCircleTargetSize);
